...
export const FinishReservation = props => {
        ...
        if (front && back && right && left) {
            ...
            Swal.fire({
                ...
                preConfirm: otpCode => {
                    ...
                    axios.put(`/finishReservation/${reservation.number}`,
                        formData,
        ...
        return (
            <React.Fragment>
                <Breadcrumb>
                    ...
                    <LinkContainer to={`/reservationDetails/${reservation.number}`} exact>
                        <Breadcrumb.Item>{t("breadcrumbs.reservationDetails")}</Breadcrumb.Item>
                    </LinkContainer>
                    <Breadcrumb.Item active>{t("breadcrumbs.finishReservation")}</Breadcrumb.Item>
                </Breadcrumb>
                <Container>
                    <Row className="justify-content-center">
                        <Col sm={6} className="form-container">
                            <h1 className="text-center">{t(`breadcrumbs.finishReservation`)}</h1>
                            ...
                            <ButtonToolbar className="justify-content-center">
                                <Button id="back"
                                        onClick={() => props.history.push(`/reservationDetails/${reservation.number}`)}>{t("navigation.back")}</Button>
                                <Button id="submit"
