...
export const CAR_CATEGORY_OTHER = "OTHER";
export const CAR_CATEGORIES = [CAR_CATEGORY_SEDAN, CAR_CATEGORY_KOMBI, CAR_CATEGORY_HATCHBACK, CAR_CATEGORY_COUPE, CAR_CATEGORY_CABRIO, CAR_CATEGORY_SUV, CAR_CATEGORY_OTHER];
