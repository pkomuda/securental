...
export const RESERVATION_STATUS_RECEPTION_PENDING = "RECEPTION_PENDING";
export const RESERVATION_STATUS_RECEPTION_ACCEPTED = "RECEPTION_ACCEPTED";
export const RESERVATION_STATUS_FINISHED = "FINISHED";
export const RESERVATION_STATUSES = [RESERVATION_STATUS_NEW, RESERVATION_STATUS_CANCELLED, RESERVATION_STATUS_RECEPTION_PENDING, RESERVATION_STATUS_RECEPTION_ACCEPTED, RESERVATION_STATUS_FINISHED];
